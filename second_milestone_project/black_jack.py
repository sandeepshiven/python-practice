...
def take_bet(chips):
    ...
    while True:
        try:
            chips.bet = int(input("How much chips do you like to bet?\n"))
        except :
            print("Please enter integer value\n")
        else:
            if chips.bet > chips.total:
                print(f"Bet amount exceded the total value {chips.total}\n")
            else:
                break
...
def hit_or_stand(deck,hand):
    ...
    while True:
        hit_stand = input("Enter h for hitting and s for stand\n")
...
while True:
    ...
    player_chips = Chips(initial_chips)
    ...
    initial_chips = player_chips.total
